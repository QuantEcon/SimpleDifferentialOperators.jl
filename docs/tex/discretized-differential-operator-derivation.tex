...
\begin{itemize}
	\item Define an irregular grid $\set{z_i}_{i=1}^P$ with $z_1 = \underline{z}$ and $z_P = \overline{z}$. Denote the grid with the variable name, i.e. $z \equiv \set{z_i}_{i=1}^P$.
...
Similarly, by \eqref{eq:new-BC2}, we have
\begin{align}
&\dfrac{\Delta_{P,-} v( \overline{z} + \Delta_{P,+}) - (\Delta_{P,+} + \Delta_{P,-}) v(\overline{z} ) + \Delta_{P,+}  v( \overline{z} - \Delta_{P,-})}{\frac{1}{2}(\Delta_{P,+} + \Delta_{P,-}) \Delta_{P,+} \Delta_{P,-} } \\
&=\dfrac{v (\overline{z} + \Delta_{P,-}) - 2 v(\overline{z} ) + v(\overline{z} -\Delta_{P,-})}{\Delta_{P,-}^2} \\
&=   \dfrac{v(\overline{z} - \Delta_{P,-}) - v(\overline{z})}{\Delta_{P,-}^2} + \dfrac{1}{\Delta_{P,-}}\dfrac{ v(\overline{z}+\Delta_{P,-}) - v (\overline{z}) }{\Delta_{P,-}}  \\
&= \dfrac{v(\overline{z} - \Delta_{P,-}) - v(\overline{z})}{\Delta_{P,-}^2}  - \dfrac{1}{\Delta_{P,-}} \overline{\xi} v(\overline{z})  \\ 
&= \dfrac{1}{\Delta_{P,-}^2}  (- 1 - \Delta_{P,-} \overline{\xi}) v(\overline{z})  + \dfrac{1}{\Delta_{P,-}^2}  v(\overline{z} - \Delta_{P,-})  
\end{align}
at the upper bound.
