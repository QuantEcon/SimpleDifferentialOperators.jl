...
\begin{example}
	 Consider $\overline{L} = \overline{L}_{1-}$. Note that substracting the first rows of $\overline{L}$ and by the first row of $B$ multiplied by returns an identical system.
\end{example}
