...
\begin{itemize}
	\item Define an irregular grid $\set{z_i}_{i=1}^M$ with $z_1 = \underline{z}$ and $z_{M} = \overline{z}$. Denote the grid with the variable name, i.e. $z \equiv \set{z_i}_{i=1}^M$.
	...
	\overline{\xi} v(\overline{z}) + \D[z]v(\overline{z}) &= 0\label{eq:new-BC2}
	\end{align}
\end{itemize}
...
\begin{align}
\dfrac{v (\overline{z} + \Delta) - 2 v(\overline{z} ) + v(\overline{z} -\Delta)}{\Delta^2} &=   \dfrac{v(\overline{z} - \Delta) - v(\overline{z})}{\Delta^2} + \dfrac{1}{\Delta}\dfrac{ v(\overline{z}+\Delta) - v (\overline{z}) }{\Delta}  \\
&= \dfrac{v(\overline{z} - \Delta) - v(\overline{z})}{\Delta^2}  - \dfrac{1}{\Delta} \overline{\xi} v(\overline{z})  \\ 
&= \dfrac{1}{\Delta^2}  (- 1 - \Delta \overline{\xi}) v(\overline{z})  + \dfrac{1}{\Delta^2}  v(\overline{z} - \Delta)  
\end{align}
at the upper bound.
...
\begin{align}
\dfrac{v(\overline{z} + \Delta_{M, +}) - v( \overline{z})}{\Delta_{M, +}} &= - \overline{\xi} v(\overline{z})
\end{align}
at the upper bound.
...
&=
\dfrac{v (\underline{z}+\Delta_{1, +}) - 2 v(\underline{z}) + v(\underline{z}-\Delta_{1, +})}{\Delta_{1, +}^2} \\ 
...
Similarly, by \eqref{eq:new-BC2}, we have
\begin{align}
&\dfrac{\Delta_{M,-} v( \overline{z} + \Delta_{M,+}) - (\Delta_{M,+} + \Delta_{M,-}) v(\overline{z} ) + \Delta_{M,+}  v( \overline{z} - \Delta_{M,-})}{\frac{1}{2}(\Delta_{M,+} + \Delta_{M,-}) \Delta_{M,+} \Delta_{M,-} } \\
&=\dfrac{v (\overline{z} + \Delta_{M,-}) - 2 v(\overline{z} ) + v(\overline{z} -\Delta_{M,-})}{\Delta_{M,-}^2} \\
&=   \dfrac{v(\overline{z} - \Delta_{M,-}) - v(\overline{z})}{\Delta_{M,-}^2} + \dfrac{1}{\Delta_{M,-}}\dfrac{ v(\overline{z}+\Delta_{M,-}) - v (\overline{z}) }{\Delta_{M,-}}  \\
&= \dfrac{v(\overline{z} - \Delta_{M,-}) - v(\overline{z})}{\Delta_{M,-}^2}  - \dfrac{1}{\Delta_{M,-}} \overline{\xi} v(\overline{z})  \\ 
&= \dfrac{1}{\Delta_{M,-}^2}  (- 1 - \Delta_{M,-} \overline{\xi}) v(\overline{z})  + \dfrac{1}{\Delta_{M,-}^2}  v(\overline{z} - \Delta_{M,-})  
\end{align}
at the upper bound.
